export function canonicalRecord(a,provenance={}){
 ...
 semantic_traits:a.semantic_traits,traits:a.traits,visual_anomaly:a.visual_anomaly,name:a.name,lore:a.lore,condition:a.condition,stats:a.stats,anomaly_domain:a.anomaly_domain,pixels:a.pixels,svg:a.svg,provenance};
}
